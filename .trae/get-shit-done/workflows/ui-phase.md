...
```markdown
Read /workspace/.trae/agents/gsd-ui-researcher.md for instructions.
...
Template: /workspace/.trae/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read /workspace/.trae/agents/gsd-ui-checker.md for instructions.

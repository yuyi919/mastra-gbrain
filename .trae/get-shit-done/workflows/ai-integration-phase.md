...
```markdown
Read /workspace/.trae/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "/workspace/.trae/get-shit-done/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read /workspace/.trae/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read /workspace/.trae/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read /workspace/.trae/agents/gsd-eval-planner.md for instructions.

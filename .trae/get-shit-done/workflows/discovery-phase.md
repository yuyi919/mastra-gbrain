...
See /workspace/.trae/get-shit-done/templates/discovery.md `<discovery_protocol>` for full protocol.
</source_hierarchy>
...
6. **Create DISCOVERY.md** using /workspace/.trae/get-shit-done/templates/discovery.md structure:
...
1. **Scope the discovery** using /workspace/.trae/get-shit-done/templates/discovery.md:
...
6. **Create comprehensive DISCOVERY.md:**
   ...
   - Full structure from /workspace/.trae/get-shit-done/templates/discovery.md
...
Use /workspace/.trae/get-shit-done/templates/discovery.md.

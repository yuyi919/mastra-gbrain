...
<required_reading>
@/workspace/.trae/get-shit-done/references/domain-probes.md
@/workspace/.trae/get-shit-done/references/gate-prompts.md
@/workspace/.trae/get-shit-done/references/universal-anti-patterns.md
</required_reading>
...
- Read and execute @/workspace/.trae/get-shit-done/workflows/discuss-phase-power.md end-to-end
...
```bash
PROFILE_CONTENT=$(cat "/workspace/.trae/get-shit-done/USER-PROFILE.md" 2>/dev/null || true)
```
...
2. For EACH user-selected gray area, spawn a Task() in parallel:
   ...
   Task(
     prompt="First, read @/workspace/.trae/agents/gsd-advisor-researcher.md for your role and instructions.
...
**Full step-by-step instructions:** @/workspace/.trae/get-shit-done/workflows/discuss-phase-power.md

...
```bash
INIT=$(node "/workspace/.trae/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/workspace/.trae/get-shit-done/templates/spec.md.

...
<template>
@/workspace/.trae/get-shit-done/templates/UAT.md
</template>
...
Read and follow `/workspace/.trae/get-shit-done/workflows/transition.md`.
...
```bash
node "/workspace/.trae/get-shit-done/bin/gsd-tools.cjs" audit-open --json 2>/dev/null
```
...
- Follow @/workspace/.trae/get-shit-done/workflows/diagnose-issues.md

...
```bash
node "/workspace/.trae/get-shit-done/bin/gsd-tools.cjs" audit-open 2>/dev/null
```
...
**If doesn't exist:** Create from template at `/workspace/.trae/get-shit-done/templates/retrospective.md`.

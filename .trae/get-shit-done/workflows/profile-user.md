...
Key references:
- @/workspace/.trae/get-shit-done/references/ui-brand.md (display patterns)
- @/workspace/.trae/get-shit-done/agents/gsd-user-profiler.md (profiler agent definition)
- @/workspace/.trae/get-shit-done/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
PROFILE_PATH="/workspace/.trae/get-shit-done/USER-PROFILE.md"
...
```bash
cp "/workspace/.trae/get-shit-done/USER-PROFILE.md" "/workspace/.trae/USER-PROFILE.backup.md"
```
...
✓ Stores profile at /workspace/.trae/get-shit-done/USER-PROFILE.md
...
- The user-profiling reference doc at `/workspace/.trae/get-shit-done/references/user-profiling.md`
...
Reference: @/workspace/.trae/get-shit-done/references/user-profiling.md
...
Display: "✓ Profile written to /workspace/.trae/get-shit-done/USER-PROFILE.md"
...
- options (ALL pre-selected by default):
  ...
  - "Global .trae/rules/" -- "Add profile to /workspace/.trae/.trae/rules/ for all projects"

**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at /workspace/.trae/get-shit-done/USER-PROFILE.md" and jump to step 10.
...
Display: "✓ Generated /gsd-dev-preferences at /workspace/.trae/commands/gsd/dev-preferences.md"
...
Display: "✓ Added profile section to /workspace/.trae/.trae/rules/"
...
```bash
BACKUP_PATH="/workspace/.trae/USER-PROFILE.backup.md"
```
...
Your profile:    /workspace/.trae/get-shit-done/USER-PROFILE.md
```

Then list paths for each generated artifact:
```
Artifacts:
  ✓ /gsd-dev-preferences   /workspace/.trae/commands/gsd/dev-preferences.md
  ✓ .trae/rules/ section       .trae/rules/
  ✓ Global .trae/rules/        /workspace/.trae/.trae/rules/
```

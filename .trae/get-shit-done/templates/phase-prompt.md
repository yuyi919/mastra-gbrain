...
<!-- For checkpoint task examples and patterns, see @/workspace/.trae/get-shit-done/references/checkpoints.md -->
...
See `/workspace/.trae/get-shit-done/references/tdd.md` for TDD plan structure.
...
See `/workspace/.trae/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `/workspace/.trae/get-shit-done/workflows/verify-phase.md` for verification logic.

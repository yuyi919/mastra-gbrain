...
**Project instructions:** Read `.trae/rules/` if it exists in the working directory. Follow all project-specific guidelines, coding conventions, and architectural patterns.

...
<reference>
@/workspace/.trae/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `/workspace/.trae/get-shit-done/references/user-profiling.md` to load:

...
<required_reading>
@/workspace/.trae/get-shit-done/references/common-bug-patterns.md
</required_reading>
...
@/workspace/.trae/get-shit-done/references/debugger-philosophy.md
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /workspace/.trae
                  → checks /workspace/.trae/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /workspace/.trae/get-shit-done
                  → writes to /workspace/.trae/get-shit-done/hooks/
...
@/workspace/.trae/get-shit-done/references/thinking-models-debug.md
...
- Read @/workspace/.trae/get-shit-done/references/common-bug-patterns.md

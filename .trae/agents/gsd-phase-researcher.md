...
@/workspace/.trae/get-shit-done/references/thinking-models-research.md
...
```bash
node "/workspace/.trae/get-shit-done/bin/gsd-tools.cjs" graphify query "<capability-keyword>" --budget 1500
```

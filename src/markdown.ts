...
import type { PageType, ParsedMarkdown } from "./types.js";
...
function inferType(filePath?: string): PageType {
  ...
  if (lower.includes("/companies/") || lower.includes("/company/"))
    return "company";
  ...
  if (lower.includes("/projects/") || lower.includes("/project/"))
    return "project";
  if (lower.includes("/sources/") || lower.includes("/source/"))
    return "source";
